...
import { Avatar, List, message, Rate, Modal } from "antd";
...
import image from '../../assets/emp.jfif'
  ...
  const appendData = () => {
    http
      ...
      .then((res) => {
        ...
        message.success(`${res.data.result.length} more items loaded!`);
        // setRefresh(!refresh);
      })
      .catch((err) => {
