...
function Team() {const [active, setActive] = useState(false);
  ...
  <SideandNavbar/>
    <Box
      ...
      >
        <Container maxWidth="xxl"  sx={{ mt: 10, mb: 4,ml:0 }}>
          <Grid container sx={{display:'flex',justifyContent:'center'}}  columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
    ...
    >
      <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
        <Avatar src={emp.first_name.toUpperCase().charAt(0)} sx={{ '--Avatar-size': '4rem' }} />
        <Chip
          size="sm"
          variant="soft"
          color="primary"
